...
| Slow or huge requests/responses                   | Caller admission before request parsing; request-body, DNS, hop, total, redirect, declared-size, streamed-size, and exact MIME limits                                                      | Instance-local admission is not a distributed denial-of-service control.                                                                                                                                                         |
