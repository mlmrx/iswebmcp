...
Protocol: synthetic-consistency-v1. 22 passed, 0 failed across 22 purposively authored pairs.
...
| comment-script-hint          | same-assessment        | pass   |
| template-script-hint         | same-assessment        | pass   |
| escaped-code-example         | same-assessment        | pass   |
| comment-structured-data      | same-assessment        | pass   |
| comment-page-title           | same-assessment        | pass   |
...
| html-tag-case                | same-assessment        | pass   |
...
| empty-label                  | field-name-decrease    | pass   |
| dangling-labelledby          | field-name-decrease    | pass   |
